...
def write_silver_standard_labels(corpus,
	...
	pred_outcome_binary_df.set_index(df_data['Accession Number'],inplace=True)
	pred_outcome_proba_df.set_index(df_data['Accession Number'],inplace=True)
...
def give_stop_words():
	...
	Returns:
		...
		stop_words: a list of stop words. note - we have removed stop words from this example; you can add them below if you have a list of stop words for your application.
	"""
